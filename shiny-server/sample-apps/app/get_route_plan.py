...
def process_user_input(starting_brewery, crawl_starts_at,
                       minutes_per_bar, crawl_duration):
...
def generate_route_plan(data, brewery_timings, starting_brewery, crawl_starts_at,
                        minutes_per_bar, crawl_duration):
